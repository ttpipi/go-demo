...
var (
	pattern_ProdService_GetProdStock_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "prod", "Id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ProdService_GetProdStocks_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "prods", "Size"}, "", runtime.AssumeColonVerbOpt(true)))
)
