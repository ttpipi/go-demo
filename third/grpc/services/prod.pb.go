...
type ProdRequest struct {
	...
	Area ProdAreas `protobuf:"varint,2,opt,name=area,proto3,enum=services.ProdAreas" json:"area,omitempty"`
}
...
func (x *ProdRespon) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProdRespon) ProtoMessage() {}

func (x *ProdRespon) ProtoReflect() protoreflect.Message {
	mi := &file_prod_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProdRespon.ProtoReflect.Descriptor instead.
func (*ProdRespon) Descriptor() ([]byte, []int) {
	return file_prod_proto_rawDescGZIP(), []int{1}
}

func (x *ProdRespon) GetStock() int32 {
	if x != nil {
		return x.Stock
	}
	return 0
...
type ProdResponList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Stocks []*ProdRespon `protobuf:"bytes,1,rep,name=Stocks,proto3" json:"Stocks,omitempty"`
}

func (x *ProdResponList) Reset() {
	*x = ProdResponList{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProdResponList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProdResponList) ProtoMessage() {}

func (x *ProdResponList) ProtoReflect() protoreflect.Message {
	mi := &file_prod_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProdResponList.ProtoReflect.Descriptor instead.
func (*ProdResponList) Descriptor() ([]byte, []int) {
	return file_prod_proto_rawDescGZIP(), []int{3}
}

func (x *ProdResponList) GetStocks() []*ProdRespon {
	if x != nil {
		return x.Stocks
	}
	return nil
...
var file_prod_proto_rawDesc = []byte{
	...
	,
	...
	0x76, 0x31, 0x2f, 0x70, 0x72, 0x6f, 0x64, 0x73, 0x2f, 0x7b, 0x53, 0x69, 0x7a, 0x65, 0x7d, 0x12,
	0x3b, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x15,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	0x2e, 0x50, 0x72, 0x6f, 0x64, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x22, 0x00, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_prod_proto_goTypes = []interface{}{
	...
	(*ProdRespon)(nil),     // 2: services.ProdRespon
	(*QuerySize)(nil),      // 3: services.QuerySize
	(*ProdResponList)(nil), // 4: services.ProdResponList
	(*ProdModel)(nil),      // 5: services.ProdModel
}
var file_prod_proto_depIdxs = []int32{
	0, // 0: services.ProdRequest.area:type_name -> services.ProdAreas
	2, // 1: services.ProdResponList.Stocks:type_name -> services.ProdRespon
	...
	2, // 5: services.ProdService.GetProdStock:output_type -> services.ProdRespon
	4, // 6: services.ProdService.GetProdStocks:output_type -> services.ProdResponList
...
type ProdServiceClient interface {
	//获取商品id库存
	GetProdStock(ctx context.Context, in *ProdRequest, opts ...grpc.CallOption) (*ProdRespon, error)
	//获取多个商品库存
	GetProdStocks(ctx context.Context, in *QuerySize, opts ...grpc.CallOption) (*ProdResponList, error)
	//获取商品详情
...
func (c *prodServiceClient) GetProdStock(ctx context.Context, in *ProdRequest, opts ...grpc.CallOption) (*ProdRespon, error) {
	out := new(ProdRespon)
...
func (c *prodServiceClient) GetProdStocks(ctx context.Context, in *QuerySize, opts ...grpc.CallOption) (*ProdResponList, error) {
	out := new(ProdResponList)
...
type ProdServiceServer interface {
	//获取商品id库存
	GetProdStock(context.Context, *ProdRequest) (*ProdRespon, error)
	//获取多个商品库存
	GetProdStocks(context.Context, *QuerySize) (*ProdResponList, error)
	//获取商品详情
...
func (*UnimplementedProdServiceServer) GetProdStock(context.Context, *ProdRequest) (*ProdRespon, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProdStock not implemented")
}
func (*UnimplementedProdServiceServer) GetProdStocks(context.Context, *QuerySize) (*ProdResponList, error) {
